...
export const MEDICATION_API = {
    GET_A_MEDICATION: `${getBaseUrl().api}/service_medication/query/getAMedication`,
    GET_MEDICATIONS: `${getBaseUrl().api}/service_medication/query/getMedications`,
    GET_A_MEDICATION_IMAGE: `${getBaseUrl().api}/service_medication/query/getAMedicationImage`,
    GET_A_MEDICATION_VIDEO: `${getBaseUrl().api}/service_medication/query/getAMedicationVideo`,
    GET_ALL_MEDICATION_IMAGES: `${getBaseUrl().api}/service_medication/query/getAllMedicationImages`,
    GET_ALL_MEDICATION_VIDEOS: `${getBaseUrl().api}/service_medication/query/getAllMedicationVideos`,
    GET_MEDICATION_COMMENTS: `${getBaseUrl().api}/service_medication/query/getMedicationComments`,
    CREATE_MEDICATION: `${getBaseUrl().api}/service_medication/mutate/createMedication`,
    CREATE_MEDICATION_COMMENT: `${getBaseUrl().api}/service_medication/mutate/createMedicationComment`,
};
