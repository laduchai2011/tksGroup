...
class ScrollImageEvent {
    private _images_container_element: Element;
    ...
    constructor(
        images_container_element: Element,
        ...
        this._images_container_element = images_container_element;
    ...
    private handle_scroll = (index: number) => {
        const { clientWidth } = this._images_container_element;
        this._images_container_element.scrollTo({
