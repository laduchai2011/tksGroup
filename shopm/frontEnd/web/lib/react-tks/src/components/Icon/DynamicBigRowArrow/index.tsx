...
const DynamicBigRowArrow: FC<MyDynamicBigRowArrowProps> = ({
  ...
  return (
    ...
    >
      ...
      <path
        d={`M${center_of_rectangle_x + offset_x},0 L${
          center_of_rectangle_x + 12 - offset_x
        },12 L${center_of_rectangle_x + offset_x},24 L${
          center_of_rectangle_x - 12 + offset_x
        },24 L${center_of_rectangle_x - offset_x},12 L${
          center_of_rectangle_x - 12 + offset_x
        },0 L${center_of_rectangle_x + offset_x},0 Z`}
      />
      <path
        d={`M${center_of_rectangle_x - 6 + offset_x},0 L${
          center_of_rectangle_x + 6 - offset_x
        },12 L${center_of_rectangle_x - 6 + offset_x},24 L${
          center_of_rectangle_x + 6 - offset_x
        },12 L${center_of_rectangle_x - 6 + offset_x},0 Z`}
      />
      {props.children}
    </svg>
  );
