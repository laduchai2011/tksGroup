...
const Table: FC<MyTableProps> = ({ table, className, ...props }) => {
    ...
    const columnAmount = useRef<number>(0);
    const rowAmount = useRef<number>(0);
    ...
    // resizable
    const cell_X = useRef<number>(0);
    const cell_Y = useRef<number>(0);
    const cellWidth = useRef<number>(0);
    const cellHeight = useRef<number>(0);
    const isResizable_X = useRef<boolean>(false);
    const isResizable_Y = useRef<boolean>(false);
    const selectedColumn = useRef<number | undefined>(undefined);
    const selectedRow = useRef<number | undefined>(undefined);
